      ...
      <q-card class="q-pa-md"
        ...
        <q-card-section>
          ...
          <div class="row q-my-md">
            <div class="section primary-gradient col-12" v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram')">
              <div class="text-h8" v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram') " style="margin-top: 20px;">ChatGPT</div>
              <div class="col-12 " v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram') ">
              ...
              <label v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram') " class="text-caption">Após mudar o Prompt, o histórico do ChatGPT deve ser restaurado clicando no botão abaixo:</label>
              <q-btn round
                flat
                dense
                @click="limparGpts()"
                v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram') "
                >
                <q-icon size="2em"
                  name="mdi-restore" />
                <q-tooltip>
              ...
              <label v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram') " class="text-caption">Ao usar o Assistente o Prompt será desconsiderado</label>
              <q-btn round
                flat
                dense
            ...
            <div class="section primary-gradient col-12" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram')">
              <div class="text-h8" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram') " style="margin-top: 20px;">TypeBOT</div>
              <div class="col-12" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram')">
            ...
            <div class="section primary-gradient col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys')">
              <div class="text-h8" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys') " style="margin-top: 20px;">Dify (Beta)</div>
              <div class="col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys')">
            ...
            <div class="section primary-gradient col-12" v-if="n8nAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba')">
              <div class="text-h8" v-if="n8nAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba') " style="margin-top: 20px;">N8N</div>
            ...
            <div class="section primary-gradient" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba'">
            ...
            <div class="section primary-gradient" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba'">
            <div >
              <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'waba' || whatsapp.type === 'baileys'">
                <q-item tag="label" v-ripple>
                  <q-item-section>
            ...
            <div>
              <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba'">
                <q-item tag="label" v-ripple>
                  <q-item-section>
